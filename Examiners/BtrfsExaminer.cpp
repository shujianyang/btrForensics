...
namespace btrForensics {
    ...
    void BtrfsExaminer::initializeRootTree()
    {
    ...
    //!
    bool BtrfsExaminer::getPhyAddrFromChunkTree(const LeafNode* leaf, uint64_t targetLogAddr,
    ...
    //!
    bool BtrfsExaminer::treeSearch(const BtrfsNode *node,
